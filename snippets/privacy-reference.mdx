...
|-------|----------------|
| Access your data | Email security@usetero.com for JSON export |
| Correct your data | Update in account settings or contact us |
| Delete your data | Email security@usetero.com (deleted within 30 days) |
