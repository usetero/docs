...
See [Subprocessors and Third Parties](/trust/assurance/subprocessors-third-parties) for complete details.
...
We respond to all requests within 30 days and support GDPR (EU) and CCPA (California) rights. Workspace deletion removes all associated telemetry metadata, quality rules, and configurations.
...
When you delete your account or workspace, we remove data from active systems within 30 days and delete backup copies when backups expire.
