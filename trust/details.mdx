...
|-------------|-------------------|
| [Datadog](/integrations/observability/datadog#permissions) | Logs, metrics, traces, service catalog. Optional write access for exclusion filters. |
| [Splunk](/integrations/observability/splunk#permissions) | Logs, index metadata. Optional write access for ingest actions. |
| [GitHub](/integrations/code/github#permissions) | Repository contents, PRs, issues. For code fixes and policy sync. |
| [Anthropic](/integrations/ai/anthropic) | Telemetry samples for AI classification. Zero retention. |
