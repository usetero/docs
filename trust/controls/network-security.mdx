...
Tero requires TLS for integration traffic and protects hosted endpoints at the Cloudflare edge. This page covers that baseline and the connectivity options by deployment model.
...
| Private connectivity model | Available based on customer requirements | Customer-managed |
| Destination restrictions | Allowlisting support for customer integrations | Customer-managed |
