  ...
  <Tab title="Tero Distro">
    ...
    <Steps>
      <Step title="Create an API key">
        ...
        Navigate to **Edge** → **API Keys** → **Create**. Name your key (e.g., "Tero Collector"). Copy the key when shown. Tero shows it once.
      </Step>
  ...
  <Tab title="Edge Proxy">
    ...
    <Steps>
      <Step title="Create an API key">
        ...
        Navigate to **Edge** → **API Keys** → **Create**. Name your key (e.g., "OTel Collector"). Copy the key when shown. Tero shows it once.
      </Step>
  ...
  <Tab title="Policy Processor">
    ...
    <Steps>
      <Step title="Create an API key">
        ...
        Navigate to **Edge** → **API Keys** → **Create**. Name your key (e.g., "Custom Collector"). Copy the key when shown. Tero shows it once.
      </Step>
