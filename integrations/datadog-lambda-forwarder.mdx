...
<Tabs>
  <Tab title="CloudFormation">
    ...
    <Card
      title="Launch Stack"
      icon="aws"
      href="https://console.aws.amazon.com/cloudformation/home#/stacks/create/review?templateURL=https://tero-public.s3.us-east-1.amazonaws.com/lambda/template.yaml"
      horizontal
    >
  ...
  <Tab title="Manual">
    ...
    <Steps>
      <Step title="Create a Tero API key">
        ...
        Navigate to **Edge** → **API Keys** → **Create**. Name your key (e.g., "Lambda forwarder"). Copy the key when shown. Tero shows it once.
