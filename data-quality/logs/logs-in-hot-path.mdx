...
Tero identifies hot path logs by analyzing volume and variance in your [context graph](/context/overview). A log event that fires at extremely high rates with low content variance is flagged.
