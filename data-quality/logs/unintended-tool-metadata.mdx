...
Tero checks every signal in your [context graph](/context/overview): query history, dashboards, alerts, saved searches. Fields that exist on logs but never appear anywhere are flagged as unused.
