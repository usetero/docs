...
Tero identifies excessive payloads by analyzing field sizes across your [context graph](/context/overview). Fields that consistently exceed a size threshold (like `http.response.body` or `request.payload`) are flagged.
