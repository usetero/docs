...
<Note>
Use this when you don't have [Edge](/edge/overview) deployed or want to configure provider-specific features like index routing.
</Note>
...
<Tabs>
  ...
  <Tab title="OpenTelemetry">
    <Frame>
      <img src="/images/how-it-works-otel-4-in-provider.svg" alt="Enforce in provider with OpenTelemetry" />
    </Frame>
...
You approve the rule and select "Enforce in provider." Tero configures an exclusion filter in Datadog:
...
Your data quality dashboard updates as Datadog reports the change. If something goes wrong, disable the rule and Tero removes the exclusion filter. Logs index normally again.
...
If you need maximum control, egress savings, or sub-millisecond latency, use [Enforce at edge](/data-quality/enforcement/enforce-at-edge) instead.
