...
<CardGroup cols={1}>
  ...
  <Card title="Medium risk" icon="circle-exclamation" color="#ef4444" horizontal>
    Requires discussion with the team: [Excessive payloads](/data-quality/categories/logs/excessive-payloads), [Excessive repetition](/data-quality/categories/logs/excessive-repetition), [Debug mode left on](/data-quality/categories/logs/debug-mode-left-on), and more
  </Card>
</CardGroup>
