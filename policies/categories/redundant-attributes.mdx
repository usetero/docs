...
Tero analyzes every log event in your [Master Catalog](/master-catalog). When two fields contain identical values consistently (exact string matches, timestamps that differ only in format, numeric fields with the same value) they're flagged as redundant.
