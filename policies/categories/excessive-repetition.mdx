...
<CardGroup cols={2}>
  ...
  <Card title="Set SLOs" icon="chart-line" href="/policies/enforcement/set-slos">
...
Tero identifies excessive repetition by analyzing volume spikes and content variance in your [Master Catalog](/master-catalog). A log event that suddenly spikes 100x with identical content is flagged.
