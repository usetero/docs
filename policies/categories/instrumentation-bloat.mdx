...
Tero maps your dependencies and instrumentation stack. Fields like `telemetry.sdk.version` and `otel.library.name` come from tooling rather than application code. Tero flags them as instrumentation bloat.
