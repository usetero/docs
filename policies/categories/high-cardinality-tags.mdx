...
Tero analyzes tag cardinality across your [Master Catalog](/master-catalog). Tags with thousands of unique values (user IDs, request IDs, session tokens) are flagged as high cardinality.
