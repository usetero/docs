...
After Datadog applies the filter, matching logs stop being indexed. You still see them in Live Tail (they reach Datadog), but they don't count against your indexed volume.
