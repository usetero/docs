...
<Note>
Use this for code-level issues like accidental debug statements, excessive payloads, or logs in hot paths. The waste stops being generated instead of being filtered downstream.
</Note>
...
Your team reviews the PR. Once merged and deployed, the application stops generating those logs, so the fix removes the waste at the source.
