...
Tero creates a ticket in your issue tracker with the affected service, evidence, cost impact, and suggested next steps. The ticket is assigned based on service ownership from your [Master Catalog](/master-catalog/services).
