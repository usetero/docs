...
Tero creates a ticket in your issue tracker with all the context needed to understand and fix the problem. The ticket is assigned based on service ownership from your [Master Catalog](/master-catalog/services).
...
The ticket is assigned to the user-service team based on your Master Catalog. They investigate, change the configuration, and close the ticket.
