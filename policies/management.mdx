...
Policies sync to each service's repository in a `.tero/` folder. Engineers see what happens to their service's data. Changes come via PR, either from Tero or from engineers directly.
