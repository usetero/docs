...
<Tabs>
  ...
  <Tab title="Splunk">
    ...
    Tero configures [Ingest Actions](https://docs.splunk.com/Documentation/SplunkCloud/latest/Data/DataIngest) to filter waste before indexing. See [Splunk integration →](/integrations/observability/splunk#actions)
  </Tab>
</Tabs>
...
[Connect GitHub](/integrations/code/github) to enable pull requests.
...
[Connect GitHub](/integrations/code/github) to enable issues.
