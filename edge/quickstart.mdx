---
title: "Quickstart"
description: "Get Edge running locally"
icon: "rocket"
iconType: "duotone"
---

This guide gets Edge running locally with a file-backed policy.
...
Check Edge's logs for a policy match on the debug log and a forwarded request
for the error log:
