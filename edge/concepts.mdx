...
multiple matchers, and each matcher must match for the policy to apply (AND logic). When
...
Each policy targets one telemetry type. You cannot mix log and metric
