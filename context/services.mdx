...
Tero discovers services from your [integrations](/integrations). Each one becomes a hub in the context graph, owning [log events](/context/log-events), [trace spans](/context/trace-spans), and [metrics](/context/metrics), and relating to other services through dependencies.
