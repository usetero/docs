...
Tero discovers services from your [integrations](/integrations). Each one becomes a hub in the context graph, owning [log events](/context/log-events), connecting to [metrics](/context/metrics), and relating to other services through dependencies.
