...
<Frame>
  <img src="/images/how-it-works-otel-1.svg" alt="Connect to your observability stack" />
</Frame>
...
<Frame>
  <img src="/images/how-it-works-otel-2.svg" alt="Build context from your data" />
</Frame>
...
<Frame>
  <img src="/images/how-it-works-otel-3.svg" alt="Review and approve rules" />
</Frame>

Tero analyzes the context and surfaces rules. Specific statements about what's waste and why.

Rules are organized by category: redundant attributes, health check logs, stray debugging, verbose payloads, repetitive events. Each category has a risk level. Start with the obvious: redundant fields that duplicate other fields, debug logs that shouldn't be in production. These are zero-risk. You'll agree immediately.
...
<AccordionGroup>
  <Accordion title="In your provider" defaultOpen>
    <Frame>
      <img src="/images/how-it-works-otel-4-in-provider.svg" alt="Configure your provider" />
    </Frame>
  ...
  <Accordion title="In your infrastructure">
    <Frame>
      <img src="/images/how-it-works-otel-4-in-infrastructure.svg" alt="Execute at the edge" />
    </Frame>
