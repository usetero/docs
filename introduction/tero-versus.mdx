...
Tero can answer it. And we don't just give you a number. We show you the policies, organized by type, with examples from your actual data. That's the proof of understanding. Everything else Tero does builds on that foundation.
