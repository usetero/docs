...
Tero discovers metrics from your [integrations](/integrations) and builds understanding of what each one measures and whether it's worth keeping.
...
Tero pulls in the metric's context: what it measures, which service owns it, related log events. It answers your question with that full picture.
...
Every refinement improves the catalog.
