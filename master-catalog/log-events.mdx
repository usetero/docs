---
title: "Log Events"
description: "How Tero groups raw logs into actionable patterns"
icon: "file-lines"
iconType: "duotone"
---
...
Drill into the matchers to understand which logs this event captures. See sample instances to verify the pattern makes sense.
...
Tero pulls in the event's context: which service owns it, what attributes it has, how it relates to other events. It answers your question with that full picture.

## Refining log events

Tero classifies events automatically, but you know your systems better:

- **Reclassify** events that Tero misjudged. That "debug" log might matter.
